    ...
    <div class="panel panel-default">
      <div class="panel-heading">
		...
		<div class="col-sm-5 pull-right">
                  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-emenu" class="form-inline pull-right">
				  <?php echo $text_menu_enable; ?>
				  <label class="radio-inline">
                    <?php if ($configmenu_menu) { ?>
                    <input type="radio" name="configmenu_menu" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="configmenu_menu" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$configmenu_menu) { ?>
                    <input type="radio" name="configmenu_menu" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="configmenu_menu" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
		&nbsp;&nbsp;<button type="submit" form="form-emenu" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-xs btn-success"><i class="fa fa-check"></i></button>
        </form>
		</div>
      </div>
